...
public class Parenthesis {
	...
	public static void main(String[] args) {
		...
		/*
		 * If open and close brackets are equal in paranthesis push and pop will happen
		 * for same number of times and stack will be empty if stack is not empty then
